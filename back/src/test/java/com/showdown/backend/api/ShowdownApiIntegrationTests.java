...
class ShowdownApiIntegrationTests {
    ...
    void adminCrudPublicReadAndScoringFlowWorks() throws Exception {
        ...
        JsonNode match = postAdmin("/api/admin/tournaments/" + tournamentId + "/matches", Map.of(
                "divisionId", divisionId,
                "stageId", stageId,
                "groupId", groupId,
                "matchNo", 1,
                ...
                "courtName", "Court 1",
                "refereeName", "Ref API",
                "player1TournamentPlayerId", player1.get("id").asText(),
                "player2TournamentPlayerId", player2.get("id").asText(),
                "status", "SCHEDULED"
        ));
